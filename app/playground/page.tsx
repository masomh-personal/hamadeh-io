...
/**
 * Component playground for testing and iterating on UI components.
 * Visit /playground to see all components and their variants.
 */
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
            <header className="mb-16">
                ...
                <p className="mt-2 text-slate-400">
                    Test and iterate on UI components. Add new components as you
                    build.
                </p>
